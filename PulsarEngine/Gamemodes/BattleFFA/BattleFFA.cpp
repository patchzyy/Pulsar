...
kmRuntimeUse(0x806337f0);  // Wifi VS
kmRuntimeUse(0x80633760);  // Wifi Multiplayer VS
...
void ApplyFFABattle() {
    ...
    kmRuntimeWrite32A(0x806337f0, 0x3860087E);  // Wifi VS
    kmRuntimeWrite32A(0x80633760, 0x3860087E);  // Wifi Multiplayer VS
    ...
    if ((!isFFA || RKNet::Controller::sInstance->roomType == RKNet::ROOMTYPE_BT_REGIONAL) && RKNet::Controller::sInstance->roomType != RKNet::ROOMTYPE_VS_REGIONAL && RKNet::Controller::sInstance->roomType != RKNet::ROOMTYPE_VS_WW) {
        ...
        kmRuntimeWrite32A(0x806337f0, 0x386028de);  // Wifi VS
        kmRuntimeWrite32A(0x80633760, 0x386028de);  // Wifi Multiplayer VS
